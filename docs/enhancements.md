...
3. **[Major]** Historical trend tracking: save assessments over time and show score delta between runs ("Protect improved from 2.1 to 3.0 since Q1").
...
9. **[Minor]** Live progress indicator on the questionnaire ("14 of 23 answered"), deliberately skipped in v1 to avoid JS complexity; worth revisiting now that the form is stable.
